...
WHERE
    KCU.TABLE_NAME = 'job_post'
    AND KCU.TABLE_SCHEMA = 'db4'
    AND TC.CONSTRAINT_TYPE = 'FOREIGN KEY';

ALTER TABLE job_post
DROP FOREIGN KEY job_post_ibfk_1;

ALTER TABLE job_post
ADD CONSTRAINT job_post_ibfk_1
FOREIGN KEY (job_type_id)
REFERENCES job_type (pid)
ON DELETE CASCADE;

ALTER TABLE job_post
DROP FOREIGN KEY job_post_ibfk_2;

ALTER TABLE job_post
ADD CONSTRAINT job_post_ibfk_2
FOREIGN KEY (joblocid)
REFERENCES job_location (id)
ON DELETE CASCADE;

ALTER TABLE job_post
DROP FOREIGN KEY job_post_ibfk_3;

ALTER TABLE job_post
ADD CONSTRAINT job_post_ibfk_3
FOREIGN KEY (posted_by)
REFERENCES db1.user_account (id)
ON DELETE CASCADE;

ALTER TABLE job_post
DROP FOREIGN KEY job_post_ibfk_4;

ALTER TABLE job_post
ADD CONSTRAINT job_post_ibfk_4
FOREIGN KEY (company_id)
REFERENCES db2.company (id)
ON DELETE CASCADE;
...
ON
    ...
    AND KCU.CONSTRAINT_NAME = TC.CONSTRAINT_NAME
WHERE
    KCU.TABLE_NAME = 'job_post_activity'
    AND KCU.TABLE_SCHEMA = 'db4'
    AND TC.CONSTRAINT_TYPE = 'FOREIGN KEY';

ALTER TABLE job_post_activity
DROP FOREIGN KEY job_post_activity_ibfk_3;

ALTER TABLE job_post_activity
ADD CONSTRAINT job_post_activity_ibfk_3
FOREIGN KEY (uacid)
REFERENCES db3.skill_set (user_account_id)
ON DELETE CASCADE;
...
ALTER TABLE job_post_activity
ADD CONSTRAINT job_post_activity_ibfk_1
FOREIGN KEY (job_app_status_id)
...
ALTER TABLE jpal
DROP FOREIGN KEY jpal_ibfk_2;

ALTER TABLE jpal
ADD CONSTRAINT jpal_ibfk_2
FOREIGN KEY (jpaction_id)
REFERENCES job_app_action(id)
ON DELETE CASCADE;

ALTER TABLE jpal
DROP FOREIGN KEY jpal_ibfk_3;

ALTER TABLE jpal
ADD CONSTRAINT jpal_ibfk_3
FOREIGN KEY (userid)
REFERENCES db1.user_account(id)
ON DELETE CASCADE;