...
(7, 1007, 'https://www.liblogo.com/img-logo/ma3551wb98-mahindra-logo-what-do-the-three-lines-in-the-mahindra-logo-symbolise-quora.png'),
(8, 1008, 'https://th.bing.com/th/id/OIP.cVYipK-8JtTV2zP9VXufdAHaHa?w=168&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7'),-- asian paints
(9, 1009, 'https://th.bing.com/th/id/OIP.I-01vn--3DvPN9RrnVKNoAAAAA?rs=1&pid=ImgDetMain'),
(10, 1010, 'https://th.bing.com/th/id/OIP.TnZrqWahKbLZnOWCUzuxzwAAAA?rs=1&pid=ImgDetMain'),-- goldmansachs
(11, 1011, 'https://brandlogos.net/wp-content/uploads/2014/11/barclays_brandlogos.net_2xdee-512x87.png'),
(12, 1012, 'https://th.bing.com/th/id/OIP.9eF4fDz0ImMK_Jq12M4TlgHaCk?w=1200&h=416&rs=1&pid=ImgDetMain'),
...
(15, 1015, 'https://th.bing.com/th/id/OIP.h7KKNCgkt-RdLgsdJKJHYgAAAA?rs=1&pid=ImgDetMain'),
(16, 1016, 'https://th.bing.com/th/id/OIP.HKBYwPQG8tO5TI6xTpuSzAHaI_?rs=1&pid=ImgDetMain');
insert into company_image values (17,1017, 'https://th.bing.com/th/id/OIP.cYb24B-Ck2jdCRaV8-3MnwHaHa?rs=1&pid=ImgDetMain');

update company_image set image_url='https://th.bing.com/th/id/OIP.MPHAVL52hadir7pe0HszoAAAAA?rs=1&pid=ImgDetMain' where image_id=2;
...
FROM
    INFORMATION_SCHEMA.KEY_COLUMN_USAGE
WHERE
    TABLE_NAME = 'company_image'
    AND TABLE_SCHEMA = 'db2';

ALTER TABLE company_image
DROP FOREIGN KEY company_image_ibfk_1;
ALTER TABLE company_image
ADD CONSTRAINT company_image_ibfk_1
